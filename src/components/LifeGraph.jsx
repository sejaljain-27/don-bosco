...
export function LifeGraph({ activeIndex, onNodeClick, labels }) {
  ...
  return (
    <div className="relative w-full py-24 px-4 overflow-visible">
      <div className="max-w-full overflow-x-auto pb-12 no-scrollbar">
        <div className="min-w-[800px] relative flex items-center justify-center">
          {/* Central Axis Line */}
          <div className="absolute w-full h-[1px] bg-white/[0.05] top-1/2 -translate-y-1/2">
